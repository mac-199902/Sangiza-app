...
import com.abc.Sangiza.fragment.HistoryFragment;
...
public class InviteActivity extends Activity
{
    ...
    /*    AdView adView = new AdView(this, getString(R.string.facebook_banner_ad_unit), AdSize.BANNER_HEIGHT_50);
        ...
        try {
            BitMatrix bitMatrix = writer.encode("https://www.mediafire.com/file/xu9wmr2vki1bk7r/Sangiza.apk/file", BarcodeFormat.QR_CODE, 512, 512);
